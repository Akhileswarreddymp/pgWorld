...
class Pg_Master(pydantic.BaseModel):
    ...
    morethan_5sharing_rooms : typing.Optional[int] = pydantic.Field(0, **{})
    cost_of_5sharing : float = pydantic.Field(0.0, **{})
    cost_of_3sharing : float = pydantic.Field(0.0, **{})
    cost_of_4sharing : float = pydantic.Field(0.0,**{})
    ...
    cost_of_5sharing_wof : typing.Optional[float] = pydantic.Field(0.0, **{})
    cost_of_4sharing_wof : typing.Optional[float] = pydantic.Field(0.0, **{})
    cost_of_3sharing_wof : typing.Optional[float] = pydantic.Field(0.0, **{})
    cost_of_2sharing_wof : typing.Optional[float] = pydantic.Field(0.0, **{})
